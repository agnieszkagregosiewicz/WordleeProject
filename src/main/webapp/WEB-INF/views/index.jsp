...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">Wordlee<sup>project</sup></div>
    </a>
    ...
    <c:if test="${user == null}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="login">
                ...
                <span>Chcesz zagrać? </br>Zaloguj się</span></a>
...
<c:if test="${user == null}">
    ...
    <h1 class="h3 mb-0 text-gray-800">Witaj w Wordlee Project</h1>
    </div>
    ...
    <div class="card-body">
    <img src="${pageContext.request.contextPath}/theme/img/indexviewofgame.png" />
    </div>
    </div>
